...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      ...
      <a href="login.php" class="btn btn-primary-custom px-3 text-white">Masuk</a>
    </div>
  </div>
</nav>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 text-center">
        <img src="assets/img/1.png" alt="App" class="img-fluid">
      </div>
      <div class="col-md-6 mt-4 mt-md-0">
        ...
        <a href="login.php" class="btn btn-outline-primary" style="border-color:#6f42c1; color:#6f42c1;">Mulai Sekarang</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row align-items-center justify-content-center">
      ...
      <div class="col-md-6 ps-md-5 text-center">
        <img src="assets/img/contact.png" alt="Ilustrasi Kontak" class="img-fluid" style="max-height: 400px;">
      </div>
